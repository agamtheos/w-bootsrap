<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if(array_filter($errors)){
            ...
            $sql = "INSERT INTO perusahaan(namaPerush,alamatPerush,telpFaxPerush,emailPerush,namaCp,telpCp,tentangPerush,passwordPerush) VALUES('$namaPerush', '$alamatPerush', '$telpfaxperush', '$email', '$nama', '$telp', '$tentangPerush', '$password')";
...
<body>
 ...
 <section class="container grey-text">
    ...
    <form class="white" action="add_perusahaan.php" method="POST">
